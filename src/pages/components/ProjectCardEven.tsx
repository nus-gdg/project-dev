  ...
  return (
    <Box
      sx={{
        ...
        background: "linear-gradient(45deg, #283C77 30%, #5B84FC 100%)",
        boxShadow:
      ...
      >
        ...
        <Button
          ...
          sx={{
            ...
            "&:hover": {
              background:
                "linear-gradient(180deg, #c4a8ff 0%, #9b7bf0 60%, #7c5be6 100%)",
              boxShadow:
                "0 6px 22px rgba(140, 100, 240, 0.65), inset 0 1px 0 rgba(255,255,255,0.25)",
